    ...
    (o.GridLayer = o.Layer.extend({
      ...
      _tileCoordsToBounds: function (t) {
        var e = this._map,
          ...
          a = e.unproject(s, t.z);
        return (
          this.options.noWrap || ((r = e.wrapLatLng(r)), (a = e.wrapLatLng(a))),
    ...
    (o.ImageOverlay = o.Layer.extend({
      ...
      _animateZoom: function (t) {
        var e = this._map.getZoomScale(t.zoom),
          i = this._map._latLngToNewLayerPoint(
    ...
    (o.Tooltip = o.DivOverlay.extend({
      ...
      _setPosition: function (t) {
        var e = this._map,
          ...
          u = this._getAnchor();
        "top" === r
          ? (t = t.add(o.point(-a / 2 + l.x, -h + l.y + u.y)))
          : "bottom" === r
          ? (t = t.subtract(o.point(a / 2 - l.x, -l.y)))
          : "center" === r
          ? (t = t.subtract(o.point(a / 2 + l.x, h / 2 - u.y + l.y)))
          : "right" === r || ("auto" === r && s.x < n.x)
          ? ((r = "right"), (t = t.add([l.x + u.x, u.y - h / 2 + l.y])))
          : ((r = "left"),
        ...
        for (var s in this._layers)
          (e = this._layers[s]),
            e.options.interactive &&
              ...
              (o.DomEvent._fakeStop(t), n.push(e));
      ...
      _onUp: function (t) {
        if (!t._simulated && this._enabled) {
          ...
          for (var i in o.Draggable.MOVE)
            o.DomEvent.off(e, o.Draggable.MOVE[i], this._onMove, this).off(
              e,
              o.Draggable.END[i],
              this._onUp,
              this
